...
def tex_clnvcf_table(data):
    ...
    if data.shape[0] > 0:
        table = [
            ...
            "    \\hline",
            "    \\multicolumn{{1}}{{c}}{{Chrom}} & \\multicolumn{{1}}{{c}}{{Position}} & \\multicolumn{{1}}{{c}}{{Reference}} & \\multicolumn{{1}}{{c}}{{Sample}} & \\multicolumn{{1}}{{c}}{{Clinical significance}} \\\\",
            "    \\hline",
            "    \\endfirsthead",
            "    \\hline",
            "    \\multicolumn{{1}}{{c}}{{Chrom}} & \\multicolumn{{1}}{{c}}{{Position}} & \\multicolumn{{1}}{{c}}{{Reference}} & \\multicolumn{{1}}{{c}}{{Sample}} & \\multicolumn{{1}}{{c}}{{Clinical significance}} \\\\",
...
doclist['sec-analysis_result-subsec-qc-body-paired-notrim'] = [
    ...
    "  \\begin{{tabular}}[h]{{l c c}}",
    "    \\hline",
    "    Read GC content        & Forward (\%)       & Reversed (\%) \\\\",
    "    \\hline",
